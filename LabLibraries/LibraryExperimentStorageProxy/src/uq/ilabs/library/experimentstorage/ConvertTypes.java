...
public class ConvertTypes {
     ...
     * @return int[]
     */
    public static int[] Convert(edu.mit.ilab.ilabs.ArrayOfInt arrayOfInt) {
        int[] ints = null;
     ...
     * @return long[]
     */
    public static long[] Convert(edu.mit.ilab.ilabs.ArrayOfLong arrayOfLong) {
        long[] longs = null;
     ...
     * @return String[]
     */
    public static String[] Convert(edu.mit.ilab.ilabs.ArrayOfString arrayOfString) {
        String[] strings = null;
     ...
     *
     * @param coupon
     * @return edu.mit.ilab.ilabs.Coupon
     */
    public static edu.mit.ilab.ilabs.Coupon Convert(Coupon coupon) {
        edu.mit.ilab.ilabs.Coupon proxyCoupon = null;

        if (coupon != null) {
            proxyCoupon = new edu.mit.ilab.ilabs.Coupon();
     ...
     * @return Blob[]
     */
    public static Blob[] Convert(edu.mit.ilab.ilabs.ArrayOfBlob arrayOfBlob) {
        Blob[] blobs = null;

        if (arrayOfBlob != null) {
            edu.mit.ilab.ilabs.Blob[] proxyBlobs = arrayOfBlob.getBlob().toArray(new edu.mit.ilab.ilabs.Blob[0]);
            if (proxyBlobs != null) {
     ...
     * @return Experiment
     */
    public static Experiment Convert(edu.mit.ilab.ilabs.Experiment proxyExperiment) {
     ...
     */
    public static ExperimentRecord Convert(edu.mit.ilab.ilabs.ExperimentRecord proxyExperimentRecord) {
     ...
     * @return ExperimentRecord[]
     */
    public static ExperimentRecord[] Convert(edu.mit.ilab.ilabs.ArrayOfExperimentRecord arrayOfExperimentRecord) {
        ExperimentRecord[] experimentRecords = null;

        if (arrayOfExperimentRecord != null) {
            edu.mit.ilab.ilabs.ExperimentRecord[] proxyExperimentRecords = arrayOfExperimentRecord.getExperimentRecord().toArray(new edu.mit.ilab.ilabs.ExperimentRecord[0]);
     ...
     * @return ExperimentRecord[]
     */
    public static ExperimentRecord[] Convert(edu.mit.ilab.ilabs.ArrayOfExperimentRecord1 arrayOfExperimentRecord) {
        ExperimentRecord[] experimentRecords = null;
     ...
     */
    public static RecordAttribute Convert(edu.mit.ilab.ilabs.RecordAttribute proxyRecordAttribute) {
     ...
     * @return RecordAttribute[]
     */
    public static RecordAttribute[] Convert(edu.mit.ilab.ilabs.ArrayOfRecordAttribute arrayOfRecordAttribute) {
        RecordAttribute[] recordAttributes = null;

        if (arrayOfRecordAttribute != null) {
            edu.mit.ilab.ilabs.RecordAttribute[] proxyRecordAttributes = arrayOfRecordAttribute.getRecordAttribute().toArray(new edu.mit.ilab.ilabs.RecordAttribute[0]);
     ...
     * @return Blob
     */
    public static Blob Convert(edu.mit.ilab.ilabs.Blob proxyBlob) {
        Blob blob = null;
     ...
     */
    public static StorageStatus Convert(edu.mit.ilab.ilabs.StorageStatus proxyStorageStatus) {
     ...
     *
     * @param ints
     * @return edu.mit.ilab.ilabs.ArrayOfInt
     */
    public static edu.mit.ilab.ilabs.ArrayOfInt Convert(int[] ints) {
        edu.mit.ilab.ilabs.ArrayOfInt arrayOfInt = null;

        if (ints != null) {
            arrayOfInt = new edu.mit.ilab.ilabs.ArrayOfInt();
     ...
     *
     * @param longs
     * @return edu.mit.ilab.ilabs.ArrayOfLong
     */
    public static edu.mit.ilab.ilabs.ArrayOfLong Convert(long[] longs) {
        edu.mit.ilab.ilabs.ArrayOfLong arrayOfLong = null;

        if (longs != null) {
            arrayOfLong = new edu.mit.ilab.ilabs.ArrayOfLong();
     ...
     *
     * @param criterion
     * @return edu.mit.ilab.ilabs.Criterion
     */
    public static edu.mit.ilab.ilabs.Criterion Convert(Criterion criterion) {
        edu.mit.ilab.ilabs.Criterion proxyCriterion = null;

        if (criterion != null) {
            proxyCriterion = new edu.mit.ilab.ilabs.Criterion();
     ...
     */
    public static edu.mit.ilab.ilabs.ArrayOfCriterion Convert(Criterion[] criterions) {
        edu.mit.ilab.ilabs.ArrayOfCriterion arrayOfCriterion = null;

        if (criterions != null) {
            arrayOfCriterion = new edu.mit.ilab.ilabs.ArrayOfCriterion();
     ...
     * @return edu.mit.ilab.ilabs.ExperimentRecord
     */
    public static edu.mit.ilab.ilabs.ExperimentRecord Convert(ExperimentRecord experimentRecord) {
        edu.mit.ilab.ilabs.ExperimentRecord proxyExperimentRecord = null;

        if (experimentRecord != null) {
            proxyExperimentRecord = new edu.mit.ilab.ilabs.ExperimentRecord();
     ...
     */
    public static edu.mit.ilab.ilabs.ArrayOfExperimentRecord Convert(ExperimentRecord[] experimentRecords) {
        edu.mit.ilab.ilabs.ArrayOfExperimentRecord arrayOfExperimentRecord = null;

        if (experimentRecords != null) {
            arrayOfExperimentRecord = new edu.mit.ilab.ilabs.ArrayOfExperimentRecord();
     ...
     * @return edu.mit.ilab.ilabs.RecordAttribute
     */
    public static edu.mit.ilab.ilabs.RecordAttribute Convert(RecordAttribute recordAttribute) {
        edu.mit.ilab.ilabs.RecordAttribute proxyRecordAttribute = null;

        if (recordAttribute != null) {
            proxyRecordAttribute = new edu.mit.ilab.ilabs.RecordAttribute();
     ...
     */
    public static edu.mit.ilab.ilabs.ArrayOfRecordAttribute Convert(RecordAttribute[] recordAttributes) {
        edu.mit.ilab.ilabs.ArrayOfRecordAttribute arrayOfRecordAttribute = null;

        if (recordAttributes != null) {
            arrayOfRecordAttribute = new edu.mit.ilab.ilabs.ArrayOfRecordAttribute();
