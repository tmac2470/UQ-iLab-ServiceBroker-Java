...
public class UsersDB {
    ...
    private static final String STRCOL_Affiliation = "Affiliation";
    private static final String STRCOL_AuthorityId = "AuthorityId";
    private static final String STRCOL_AccountLocked = "AccountLocked";
    private static final String STRCOL_Password = "Password";
    private static final String STRCOL_RegisterReason = "RegisterReason";
    ...
    public int Add(UserInfo userInfo) throws Exception {
        ...
        try {
            ...
            try {
                ...
                sqlStatement.setString(6, userInfo.getAffiliation());
                sqlStatement.setInt(7, userInfo.getAuthorityId());
                sqlStatement.setString(8, userInfo.getPassword());
                sqlStatement.setString(9, userInfo.getRegisterReason());
        ...
        try {
            ...
            try {
                ...
                if (resultSet.next() == true) {
                    ...
                    userInfo.setAffiliation(resultSet.getString(STRCOL_Affiliation));
                    userInfo.setAuthorityId(resultSet.getInt(STRCOL_AuthorityId));
                    ...
                    userInfo.setRegisterReason(resultSet.getString(STRCOL_RegisterReason));
