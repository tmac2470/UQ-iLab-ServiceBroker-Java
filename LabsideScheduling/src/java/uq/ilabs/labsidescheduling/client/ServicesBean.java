...
import uq.ilabs.labsidescheduling.client.types.ListItem;
...
public class ServicesBean implements Serializable {
    ...
    private ArrayList<ListItem> CreateServiceList() {
        ...
        try {
             ...
             */
            ProcessAgentsDB processAgentsDB = this.labsideSchedulingSession.getServiceManagement().getProcessAgentsDB();
