 ...
 * @author uqlpayne
 */
public class LabsideSchedulingServlet extends HttpServlet {

    //<editor-fold defaultstate="collapsed" desc="Constants">
    private static final String STR_ClassName = LabsideSchedulingServlet.class.getName();
    ...
    @EJB
    private LabsideSchedulingAppBean labsideSchedulingBean;
    //</editor-fold>
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        try {
             ...
             */
            this.labsideSchedulingBean.Initialise(request.getServletContext());

            /*
             * Get the LabsideSchedulingSession information from the session
             */
            ...
            /*
             * Check if LabsideSchedulingSession doesn't exist
             */
            if (labsideSchedulingSession == null) {
                ...
                /*
                 * Create an instance of LabsideSchedulingSession ready to fill in
                 */
                labsideSchedulingSession = new LabsideSchedulingSession();

                /*
                 * Get ServiceManagement information and save to the session
                 */
                ServiceManagement serviceManagement = this.labsideSchedulingBean.getServiceManagement();
                labsideSchedulingSession.setServiceManagement(serviceManagement);
                ...
                if (processAgentInfo != null) {
                    labsideSchedulingSession.setTitle(processAgentInfo.getAgentName());
                    labsideSchedulingSession.setContactEmail(processAgentInfo.getSystemSupportInfo().getContactEmail());
                    labsideSchedulingSession.setServiceGuid(processAgentInfo.getAgentGuid());
                } else {
                    labsideSchedulingSession.setTitle(STR_UnregisteredService);
                }

                Logfile.Write(String.format(STRLOG_TitleVersion_arg2, labsideSchedulingSession.getTitle(), labsideSchedulingSession.getVersion()));

                /*
                 * Set LabsideSchedulingSession information in the session for access by the web pages
                 */
                httpSession.setAttribute(Consts.STRSSN_LabsideScheduling, labsideSchedulingSession);
            }
            ...
            if (servlet != null) {
                 ...
                 */
                labsideSchedulingSession.setUserSession(userSession);
            }
