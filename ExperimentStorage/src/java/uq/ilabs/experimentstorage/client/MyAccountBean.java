...
public class MyAccountBean implements Serializable {
    ...
    public MyAccountBean() {
        ...
        try {
            this.usersDB = new UsersDB(this.experimentStorageSession.getDbConnection());
        } catch (Exception ex) {
        }
    ...
    private void PopulateUserInfo() {
        ...
        try {
            UserInfo userInfo = this.usersDB.RetrieveByUsername(this.experimentStorageSession.getUserSession().getUsername());
