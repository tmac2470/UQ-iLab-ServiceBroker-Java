    ...
    public boolean handleMessage(SOAPMessageContext messageContext) {
        ...
        if ((Boolean) messageContext.get(SOAPMessageContext.MESSAGE_OUTBOUND_PROPERTY) == false) {
            try {
                 ...
                 */
                this.ilabServiceBrokerAppBean.StartService((ServletContext) messageContext.get(MessageContext.SERVLET_CONTEXT));
    ...
    private void ProcessSoapHeader(SOAPMessageContext messageContext) throws SOAPException {
        ...
        while (iterator.hasNext()) {
            ...
            if (object instanceof SOAPElement) {
                 ...
                 */
                if (localName.equalsIgnoreCase(QnameFactory.getSbAuthHeaderLocalPart()) == true) {
                    /*
                     * SbAuthHeader
                     */
                    ...
                    messageContext.setScope(sbAuthHeaderName, Scope.APPLICATION);
