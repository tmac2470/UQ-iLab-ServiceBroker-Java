...
public class SelfRegistrationBean implements Serializable {
    ...
    private final ProcessAgentTypes processAgentType = ProcessAgentTypes.ISB;
    ...
    public String actionSave() {
        ...
        if (processAgentInfo != null) {
            try {
                ...
                ProcessAgentInfo selfProcessAgentInfo = processAgentsDB.RetrieveSelf();
                if (selfProcessAgentInfo != null) {
                    processAgentsDB.Delete(selfProcessAgentInfo.getAgentId());
                }
                 ...
                 * Update session
                 */
                this.serviceBrokerSession.setTitle(processAgentInfo.getAgentName());
                this.serviceBrokerSession.setServiceGuid(processAgentInfo.getAgentGuid());
                this.serviceBrokerSession.setContactEmail(processAgentInfo.getSystemSupportInfo().getContactEmail());
