...
public class ConvertTypes {
     ...
     */
    public static edu.mit.ilab.ilabs.type.Reservation ConvertType(Reservation reservation) {
        edu.mit.ilab.ilabs.type.Reservation proxyReservation = null;

        if (reservation != null) {
            proxyReservation = new edu.mit.ilab.ilabs.type.Reservation();
            proxyReservation.setDuration(reservation.getDuration());
            proxyReservation.setUserName(reservation.getUserName());
            proxyReservation.setStartTime(Convert(reservation.getStartTime()));
        }
     ...
     */
    public static edu.mit.ilab.ilabs.services.ArrayOfReservation ConvertServices(Reservation[] reservations) {
        edu.mit.ilab.ilabs.services.ArrayOfReservation arrayOfReservation = null;

        if (reservations != null) {
            arrayOfReservation = new edu.mit.ilab.ilabs.services.ArrayOfReservation();
            for (Reservation reservation : reservations) {
                arrayOfReservation.getReservation().add(ConvertType(reservation));
            }
        }
