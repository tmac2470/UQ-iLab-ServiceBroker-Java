...
public class SelfRegistrationBean implements Serializable {
    ...
    private final ProcessAgentTypes processAgentType = ProcessAgentTypes.USS;
    ...
    public SelfRegistrationBean() {
        ...
        this.processAgentsDB = this.usersideSchedulingSession.getServiceManagement().getProcessAgentsDB();
    }
    ...
    public void pageLoad() {
         ...
         */
        if (this.usersideSchedulingSession.getUserSession() == null) {
    ...
    public String actionSave() {
        ...
        if (processAgentInfo != null) {
            try {
                 ...
                 * Update session
                 */
                this.usersideSchedulingSession.setTitle(processAgentInfo.getAgentName());
                this.usersideSchedulingSession.setServiceGuid(processAgentInfo.getAgentGuid());
                this.usersideSchedulingSession.setContactEmail(processAgentInfo.getSystemSupportInfo().getContactEmail());
