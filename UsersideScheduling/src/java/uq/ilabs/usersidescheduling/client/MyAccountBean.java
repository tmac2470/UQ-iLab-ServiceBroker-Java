...
import uq.ilabs.library.usersidescheduling.database.UsersDB;
...
public class MyAccountBean implements Serializable {
    ...
    public MyAccountBean() {
        ...
        try {
            this.usersDB = new UsersDB(this.usersideSchedulingSession.getDbConnection());
        } catch (Exception ex) {
        }
    ...
    private void PopulateUserInfo() {
        ...
        try {
            UserInfo userInfo = this.usersDB.RetrieveByUsername(this.usersideSchedulingSession.getUserSession().getUsername());
