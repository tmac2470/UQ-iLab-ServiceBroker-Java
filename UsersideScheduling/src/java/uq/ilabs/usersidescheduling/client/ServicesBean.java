...
import uq.ilabs.usersidescheduling.client.types.ListItem;
...
public class ServicesBean implements Serializable {
     ...
     */
    public ServicesBean() {
        this.usersideSchedulingSession = (UsersideSchedulingSession) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get(uq.ilabs.library.usersidescheduling.client.Consts.STRSSN_UsersideScheduling);
    }
    ...
    private ArrayList<ListItem> CreateServiceList() {
        ...
        try {
             ...
             */
            ProcessAgentsDB processAgentsDB = this.usersideSchedulingSession.getServiceManagement().getProcessAgentsDB();
